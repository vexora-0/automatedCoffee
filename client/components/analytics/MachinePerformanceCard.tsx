...
import { CheckCircle, XCircle, Activity, Star, DollarSign, Coffee } from 'lucide-react';
...
const MachinePerformanceCard: React.FC<MachinePerformanceProps> = ({
  ...
  const getMachineName = (machineId: string) => {
    ...
    return machine ? machine.name || `Machine ${machine.machine_id}` : 'All Machines';
  };
          ...
          <>
            <div className="text-center">
              <h3 className="text-xl font-semibold">
                {selectedMachine !== 'all' ? getMachineName(selectedMachine) : 'All Machines'}
              </h3>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-medium">{data.ordersCompleted}</span>
              </div>
            ...
            <div className="pt-2 border-t">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-medium">
                  {data.averageRating ? data.averageRating.toFixed(1) : 'N/A'} / 5
                  {data.ratingCount > 0 && ` (${data.ratingCount} ratings)`}
                </span>
              </div>
